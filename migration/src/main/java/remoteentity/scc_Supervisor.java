...
public class scc_Supervisor {
    ...
    public void insert(Connection sccConnection) throws SQLException {
        String query="INSERT INTO public.supervisor(id, connectiontype, maintenancearea_id ,identifier, ip_adress, \"language\", macaddress, \"password\", creationtimestamp, description, " +
                "ftp_password, ftp_username,  http_password, http_username,  isdeleted, \"type\", created_by_id,  site_id,updatetimestamp,supervisortype,isalarm,lifetest,connection,dataalignment,healthchecking,synchronization)" +
                "VALUES(?,?,?,?,?,?,?,?,CURRENT_TIMESTAMP ,?,?,?,?,?,false,?,?,?,CURRENT_TIMESTAMP,?,false,false,false,false,false,false );";
